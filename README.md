...
4. キーボードから整数を入力させ、その数が素数(1またはその数以外で割り切れない数)であるかどうかを判断するコードを記述してください。(繰り返しを使用してください)
...
6. 次のように画面に出力するコードを記述してください。(繰り返しを利用してください)
...
選択肢は以下のとおりです。
1~5
1:とてもそう思う、2:そう思う,3:そう思わない,4:とてもそう思わない
6
1:とても難しい、2:難しい、3:簡単、4:とても簡単
~~~

1. ゲームの形態、内容、アクティビティが、ゲームに集中するのに役立った。
- チャレンジ、ポイント、リーダーボード等
2. ゲームの内容は、私の興味に関連している。
- Java,プログラミング等
3. ゲームの仕組みが自分の学習方法に合っている。
4. ゲームの内容を理解し、学習教材として遊び始めるのは簡単だった。ゲームをしている間、自分が学んでいることに自信が持てた。
5. このゲームで学んだことを実際に使う機会があると思うので、前向きな気持ちになれる。
6. 難易度はどうだったか。
7. 感想(自由記述)
8. 意見(自由記述)
